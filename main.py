...
application_list_tag = main_soup.find('main', class_='vacancy-serp-content')
application_tags = application_list_tag.find_all('div', class_='serp-item')

parsed_data = []

for application_tag in application_tags:
    h3_tag = application_tag.find('h3')
    span_tag = h3_tag.find('span')
    link = span_tag.find('a', class_='bloko-link')['href']

    company_block_info_tag = application_tag.find('div', class_='vacancy-serp-item__info')
    ...
    salary_tag = application_tag.find('span', {'data-qa': 'vacancy-serp__vacancy-compensation'})
